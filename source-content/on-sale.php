...
<body>
    ...
    <div>
        <div class="align-middle">
            <div class="box-fill">
                <h1 class="whats-new">CURRENTLY ON SALE</h1>
            </div>
            <hr width="80%" size="2" color="black" class="hr-line"></hr>
        </div>
        <div class="flex-container">
            <?php
                $itemsSQL = "SELECT item_id, name, gender, charSize, price, category, isNew, onSale, quantity, link, image, alt, description FROM items WHERE onSale = 'Y'";
                ...
                while ($row = mysqli_fetch_array($result)){?>
                    <div class="flex-child">
                        ...
                        <div>
                            <p class="featured-font-new">ON SALE</p>
