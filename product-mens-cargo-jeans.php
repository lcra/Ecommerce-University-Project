...
<body>
    ...
    <?php
        $itemsSQL = "SELECT item_id, name, gender, charSize, price, category, quantity, image, alt, description FROM items WHERE item_id = 3";
        ...
        if ($row = mysqli_fetch_array($result)){?>
            <div class="content">
                ...
                <div class="product-info">
                    ...
                    <form method="post" action="product-mens-cargo-jeans.php?item_id=<?=$row['item_id']?>">
