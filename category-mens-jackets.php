...
<body>
    ...
    <div class="align-middle">
        <div class="box-fill">
            <h1 class="whats-new">MENS JACKETS</h1>
        </div>
    ...
    <div>
        <div class="flex-container">
            <?php
                $itemsSQL = "SELECT item_id, name, gender, charSize, price, category, type, quantity, link, image, alt, description FROM items WHERE type = 'Jacket' and category = 'Mens'";
